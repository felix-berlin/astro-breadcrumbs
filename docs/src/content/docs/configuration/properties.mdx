...
Controls the text transformation of the link text.

- `lower`: Transforms the link text to lower case (astro-breadcrumbs => astro breadcrumbs).
- `capitalized`: Transforms the link text to capitalized case (astro-breadcrumbs => Astro Breadcrumbs).
- `sentence`: Transforms the link text to sentence case (astro-breadcrumbs => Astro breadcrumbs).
