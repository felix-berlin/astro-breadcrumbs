...
describe("Truncated Web Component", () => {
  ...
  it("handles manual toggle via button click", () => {
    ...
    const button = breadcrumbsNav.querySelector(".c-breadcrumbs__truncated-button") as HTMLElement;
  ...
  it("disconnects observer on disconnectedCallback", () => {
    ...
    expect(resizeObserverInstance.unobserve).toHaveBeenCalledWith(breadcrumbsNav);
